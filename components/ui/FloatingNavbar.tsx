...
export const FloatingNav = ({
  ...
  return (
    ...
    >
      <nav className="flex flex-col sm:flex-row items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[4rem]">
        <Link href="#home">
          <motion.span
          ...
          >
            <span className="text-primary">jayantha</span>
