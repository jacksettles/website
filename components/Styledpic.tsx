...
const StyledPic: React.FC = () => {
  ...
  return (
    ...
    >
      <motion.div 
        className="wrapper relative w-full h-full rounded-lg bg-primary shadow-md overflow-hidden border-2 border-primary"
        animate={isAnimating ? {
          scale: [1, 1.05, 1],
          rotate: [0, 5, -5, 0],
        } : {}}
      ...
      <motion.div
        className="absolute -top-1 -left-1 w-full h-full border-2 border-primary rounded-lg"
        animate={isAnimating ? { 
          scale: [1, 1.1, 1],
          rotate: [0, -3, 0],
        } : {}}
