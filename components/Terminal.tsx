...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(() => ({
    python: [
      ...
      'print("I consider myself a machine learning engineer, a computational linguist, and an amateur philosopher with experience building and deploying machine learning models as APIs.")',
    ...
    javascript: [
      ...
      'console.log("I consider myself a machine learning engineer, a computational linguist, and an amateur philosopher with experience building and deploying machine learning models as APIs.");',
